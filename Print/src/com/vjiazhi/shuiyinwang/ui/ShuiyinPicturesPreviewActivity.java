...
public class ShuiyinPicturesPreviewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shuiyin_preview);
		...
		if(intent!=null)
		{
			...
			if(bundle!=null	)
			{
				bmpStr=bundle.getStringArrayList("SELECT_LIST");
			}
		}
